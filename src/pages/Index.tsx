        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8 text-lg text-muted-foreground leading-relaxed">
            <p className="text-xl text-center text-foreground">
              Здравствуйте! Меня зовут Валерия Паршкова, и я помогаю людям находить опору в сложных жизненных ситуациях и возвращаться к полноценной, осмысленной жизни.
            </p>

            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-foreground">Моё образование и подход</h3>
              <ul className="space-y-3 list-disc list-inside">
                <li>
                  <strong>Магистр психологии (МПГУ)</strong> — фундаментальное академическое образование, которое даёт глубокое понимание механизмов психики и современных методов психологической помощи.
                </li>
                <li>
                  <strong>Сертифицированный ACT‑терапевт</strong> (терапия принятия и ответственности, Acceptance and Commitment Therapy) — это научно обоснованный подход, который учит:
                  <ul className="mt-2 ml-6 space-y-1 list-circle">
                    <li>принимать болезненные переживания, не позволяя им контролировать жизнь;</li>
                    <li>чётко определять личные ценности;</li>
                    <li>действовать в соответствии с ними, даже когда страшно или тяжело.</li>
                  </ul>
                </li>
                <li>
                  <strong>96 часов личной терапии</strong> — я сама прошла через процесс терапии, что помогает мне глубже понимать переживания клиентов и оставаться эмпатичной на каждом этапе нашей работы.
                </li>
              </ul>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-foreground">Как проходит работа</h3>
              <p>Моя задача — создать безопасное пространство, где вы сможете:</p>
              <ul className="space-y-2 list-disc list-inside">
                <li>честно говорить о том, что вас тревожит;</li>
                <li>понимать корни своих переживаний без осуждения;</li>
                <li>осваивать практические навыки регуляции эмоций;</li>
                <li>постепенно менять поведение, опираясь на собственные ценности.</li>
              </ul>
              <p className="mt-4">
                Я не даю готовых решений и не «лечу» — я помогаю вам найти собственный путь к жизни, которая будет для вас значимой и наполненной.
              </p>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-foreground">Почему ACT?</h3>
              <p>Этот подход особенно эффективен, когда:</p>
              <ul className="space-y-2 list-disc list-inside">
                <li>традиционные методы («просто перестань думать об этом») не работают;</li>
                <li>важно научиться жить с хроническими переживаниями, не позволяя им диктовать условия;</li>
                <li>нужно восстановить контакт с тем, что действительно важно для вас.</li>
              </ul>
            </div>

            <div className="space-y-4">
              <h3 className="text-2xl font-semibold text-foreground">Моя миссия</h3>
              <p>Я верю, что каждый человек способен:</p>
              <ul className="space-y-2 list-disc list-inside">
                <li>пережить кризис и выйти из него сильнее;</li>
                <li>построить отношения, в которых есть уважение и безопасность;</li>
                <li>научиться доверять себе и своим решениям.</li>
              </ul>
              <p className="mt-4 text-center text-xl text-foreground font-medium">
                Если вы чувствуете, что застряли, устали бороться или не знаете, с чего начать — давайте вместе найдём точку опоры.
              </p>
            </div>
          </div>
        </div>
